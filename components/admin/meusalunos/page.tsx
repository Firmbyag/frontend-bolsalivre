...
const Meusalunos: React.FC<MeusalunosProps> = ({ showModal, setShowModal }) => {
  ...
  return (
    <div className="flex flex-col space-y-2">
      ...
      <p className="text-gray-500 hidden text-xs md:block">Buscar por:</p>
        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-900">
          <thead className="text-xs text-gray-900 uppercase dark:text-gray-900">
            <tr>
              ...
              <th
                scope="col"
                className="px-6 py-3 border-b border-slate-300"
              ></th>
            </tr>
          </thead>
          <tbody>
            {data &&
              data.map((student: any, index: number) => (
                <tr className="bg-transparent" key={index}>
                  <th
                    scope="row"
                    className="px-6 py-4 font-medium  border-r border-slate-300 text-gray-900 whitespace-nowrap "
                  >
                    {student.name}
                  </th>
                  ...
                  <td className="px-6 py-4  border-r border-slate-300">
                    <span className="text-gray-900 text-xs font-medium me-2 
