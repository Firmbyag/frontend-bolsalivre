          ...
          <div className="flex flex-col items-center md:items-start lg:items-start p space-y-5 lg:space-y-3">
            <div className="flex flex-col space-y-3">
              ...
              <p className="flex text-[12px] text-gray-600 justify-between items-center gap-2">
                ...
                <span>
                  Rua João Passalaqua, 181 - Bela Vista, São Paulo - SP - São
                  Paulo
                </span>
              </p>
            </div>
            <p className="border bg-orange-500 text-xs rounded-md text-white px-2 py-1">
              VAGAS 2025
            </p>
          </div>
          <div className="flex justify-center lg:flex-row lg:justify-end items-start pl-0 lg:pl-6 lg:space-x-3 md:space-x-5 mt-5 lg:mt-0">
            <div className="flex flex-col items-center space-y-2">
              <p className="text-[16px] text-gray-600 space-x-2">
                <span className="font-bold text-sm p-[2px] rounded-sm bg-[#ffb005]">
                  4.9
                </span>
            ...
            <Image
              src="https://img.imageboss.me/me/cover:center/48x48/format:auto/20200129173502210.jpg"
              height="64"
              width="64"
              loading="lazy"
              className="sub-header-pdp__logo"
              title="Logo Colégio Paulino E Paulino"
              alt="Logo Colégio Paulino E Paulino"
            />
          </div>
        </div>
        <div className="row-span-1 lg:row-span-2 w-full md:w-full flex justify-center items-center">
          <EscolaDetailCard school={school} />
        </div>
      </div>
    </>
  );
