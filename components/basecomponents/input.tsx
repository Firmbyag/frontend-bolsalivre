...
const CPFInput: React.FC<CPFInputProps> = ({ value, onChange }) => {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      />
      {!isValid && (
        <span className="text-red-500 mt-2">Formato de CPF inválido</span>
      )}
    </div>
  );
};
...
const PhoneInput: React.FC<PhoneInputProps> = ({ value, onChange }) => {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      />
      {!isValid && (
        <span className="text-red-500 mt-2">Invalid phone number format</span>
      )}
    </div>
  );
};
...
const CreditCardInput: React.FC<CreditCardInputProps> = ({
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      />
      {!isValid && (
        <span className="text-red-500 mt-2">Invalid Card Number format</span>
      )}
    </div>
  );
};
