    ...
    <div className="flex flex-col justify-center items-center bg-white w-full">
      <div className="flex flex-col items-center relative">
        ...
        <div className="flex flex-col justify-center bottom-0 lg:w-2/3 mx-5 w-lvw mt-5">
          ...
          {levels.length > 0 && (
            <div className="tag-container overflow-auto inline-flex gap-5 bg-white justify-around p-5 rounded-tl-lg">
              <button
                onClick={() => {
              ...
              >
                ...
                <span
                  className={`bg-purple-700 h-12 flex items-center justify-center group-hover:bg-purple-800
                     focus:outline-none py-1 pl-2 pr-3 rounded-lg text-nowrap`}
                >
                  Ensino Básico
                </span>
              </button>
              ...
              >
                ...
                <span
                  className={`bg-purple-700 h-12 flex items-center justify-center group-hover:bg-purple-800 focus:outline-none 
                    py-1 pl-2 pr-3 rounded-lg text-nowrap`}
                >
                  Curso Técnico
                </span>
              </button>
